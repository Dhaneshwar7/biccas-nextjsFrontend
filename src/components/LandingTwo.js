                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feBlend
                        ...
                        result="effect1_dropShadow_303_8"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_303_8"
                        result="shape"
                      />
                    </filter>
                  </defs>
        ...
        <div className="col-span-1 flex max-sm:h-fit max-sm:w-fit h-full w-full gap-8">
          <div className="h-fit w-fit">
            ...
            <h3 className="py-2 text-lg">
              <span className="font-semibold">4.9 </span>/ <span>5 Rating</span>
            </h3>
            <p className="text-lg font-semibold">Databricks</p>
          </div>
          <div className="h-fit w-fit">
            <span>
              <svg
