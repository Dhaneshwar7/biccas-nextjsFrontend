...
const Footer = () => {
  ...
  return (
    <div className="landingfive flex h-fit w-screen flex-row justify-between  bg-[#161C28] px-6 py-20 max-sm:flex max-sm:flex-col max-sm:px-6 max-sm:py-6 md:py-16 md:max-lg:px-16 lg:max-xl:px-20 xl:px-28">
      <div className="flex w-1/2 flex-col gap-5 pr-24">
        ...
        <div className="dps flex gap-1">
          <div className="h-14 w-14 overflow-hidden rounded-full bg-slate-800">
            <Image alt="footDps" src={foot1} priority width={340} height={340} ></Image>
          </div>
        </div>
      </div>
      <form
        action=""
        className="queryCard flex w-1/2 flex-col gap-4 rounded-2xl bg-slate-700 px-14 py-10"
      >
        <svg
          className="m-auto"
          width="73"
