...
import foot1 from "../../public/images/Footer/foot1.png";
import foot2 from "../../public/images/Footer/foot2.png";
import foot3 from "../../public/images/Footer/foot3.png";
import foot4 from "../../public/images/Footer/foot4.png";
...
const Footer = () => {
  ...
  return (
    <div className="landingfive flex h-fit w-screen flex-col justify-between  bg-[#161C28] px-6 py-40 max-sm:flex max-sm:flex-col max-sm:px-6 max-sm:py-6 md:pb-4 md:pt-32 md:max-lg:px-16 lg:max-xl:px-20 xl:px-28">
      <div className="flex w-full max-md:flex-col max-md:gap-5">
        <div className="flex w-1/2 flex-col gap-5 pr-24 max-md:w-full max-md:pr-0 max-md:text-center md:max-lg:pr-4">
          <h1 className="text-5xl text-white max-md:text-3xl md:max-lg:text-4xl">
            People are Saying <br /> About DoWhith
          </h1>
          <p className="text-lg text-zinc-300 max-md:text-base md:max-lg:text-base">
          ...
          <p className="text-base text-zinc-300">_ Aria Zinanrio </p>
          <div className="dps flex gap-1 max-md:self-center">
            <div className="h-14 w-14 overflow-hidden rounded-full bg-slate-800">
              <Image
                alt="footDps"
                src={foot1}
        ...
        <form
          action=""
          className="queryCard flex w-1/2 flex-col gap-4 rounded-2xl bg-slate-700 px-14 py-10 max-md:w-full max-md:gap-3 max-md:px-6 md:max-lg:px-6"
        >
          <svg
            className="m-auto"
            width="73"
          ...
          <button className="w-full rounded-lg bg-[#54BD95] py-2 text-white">
            Request Demo
          </button>
          <h5 className="-mt-4 text-end text-white">or Start Free Trial</h5>
        </form>
      </div>
      <div className="mt-20 flex w-full max-md:flex-col max-md:gap-5">
        <div className="flex w-1/2 flex-col gap-3 pr-24 max-md:w-full max-md:pr-0 max-md:text-center md:max-lg:pr-4">
          <h1 className="text-5xl text-green-500">Biccas</h1>
          <p className="text-white">Get started noew try our product</p>
          <input
            type="text"
        ...
        <div
          action=""
          className="queryCard flex w-1/2 flex-row gap-6 rounded-2xl px-14 py-10 max-md:w-full max-md:flex-col max-md:justify-between max-md:gap-2 max-md:px-6 max-md:text-center md:max-lg:justify-between md:max-lg:px-6"
        >
          <div className="flex flex-col gap-2 text-zinc-300">
            <h2 className="text-lg font-semibold text-white max-md:border-b-2 max-md:border-gray-100">
              Support
            </h2>
            <p>Help Centre</p>
